...
// Load gamepad button mapping from INI
    ...
    // Set up crash handler to write to the logs directory
    CrashHandler::SetWriteDirectory(EmuFolders::Logs);
...
int main(int argc, char * argv[]) {
    // Install crash handler for signal-safe crash reporting to crash_report.txt
